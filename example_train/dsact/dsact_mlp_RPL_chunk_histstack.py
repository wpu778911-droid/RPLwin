...
#
#  Description: example for dsac-t + RPL FWT sim (3-step action chunking + history stack) + mlp + offserial
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_id", type=str, default="env_RPL_FWTsim_chunk_histstack003", help="id of environment")
    ...
    parser.add_argument("--history_length", type=int, default=4, help="stacked observation length")
    ...
    parser.add_argument("--save_folder", type=str, default="results/RPL_FWTsim_chunk_histstack003")
    ...
    if args.get("save_env_snapshot", True):
        ...
        env_map = {
            ...
            "env_RPL_FWTsim_chunk_histstack001": "gops/env/env_FwFtracking/env_RPL_FWTsim_chunk_histstack001.py",
            "env_RPL_FWTsim_chunk_histstack003": "gops/env/env_FwFtracking/env_RPL_FWTsim_chunk_histstack003.py",
