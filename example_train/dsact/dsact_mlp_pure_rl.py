...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_id", type=str, default="env_RPL_FWTsim001", help="id of environment")
    parser.add_argument("--algorithm", type=str, default="DSACT", help="RL algorithm")
    parser.add_argument("--enable_cuda", default=False, help="Enable CUDA")
    parser.add_argument("--seed", default="0825", help="Global seed")
    ################################################
    ...
    ################################################
    # 7. Data savings
    parser.add_argument("--save_folder", type=str, default="results/RPL_FWTsim001")
    ...
    if args.get("save_env_snapshot", True):
        ...
        env_map = {
            ...
            "env_pure_rl_fatte": "gops/env/env_FwFtracking/env_pure_rl_fatte.py",
